...
Command: npx gltfjsx@6.4.1 phantoms.glb --transform 
Files: phantoms.glb [6.41MB] > D:\Portfolio\phantom\public\models\phantoms-transformed.glb [192.52KB] (97%)
*/
...
export function Phantom(props) {
  ...
  useLayoutEffect(() => {
    ...
    .to(robot.current.position, {x: 0}, 2)
